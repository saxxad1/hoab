...
const entities: Record<string, EntityConfig> = {
  houseboats: { table: "houseboats", required: ["membership_number", "slug", "name_en", "owner_name", "contact_number"], softDelete: true, booleanFields: ["air_conditioned", "featured", "published"], integerFields: ["capacity", "cabins", "display_order"], fields: ["membership_number","slug","name_en","name_bn","owner_name","contact_number","secondary_phone","email","whatsapp","website","facebook_url","category","status","description_en","description_bn","capacity","cabins","air_conditioned","address","district","operating_area","amenities","cover_image","gallery","joining_date","last_verified_at","featured","published","display_order","seo_title","seo_description"] },
  posts: { table: "posts", required: ["slug", "title_en"], booleanFields: ["pinned"], timestampFields: ["published_at"], fields: ["slug","type","category","title_en","title_bn","excerpt_en","excerpt_bn","content_en","content_bn","featured_image","attachment","published_at","status","pinned"] },
  leadership: { table: "leadership", required: ["panel", "name_en", "designation_en"], integerFields: ["display_order"], fields: ["panel","term","name_en","name_bn","designation_en","designation_bn","organization","bio_en","bio_bn","photo","status","display_order"] },
  ...
  resources: { table: "resources", required: ["title_en"], booleanFields: ["published"], integerFields: ["display_order"], fields: ["title_en","title_bn","category","description_en","description_bn","file_url","external_url","published","display_order"] },
  events: { table: "events", required: ["name_en","event_date"], booleanFields: ["published"], fields: ["name_en","name_bn","event_date","start_time","end_time","venue","description_en","description_bn","poster","registration_url","status","published"] },
  pages: { table: "pages", required: ["page_key","title_en"], booleanFields: ["published"], fields: ["page_key","title_en","title_bn","content_en","content_bn","published"] },
  categories: { table: "boat_categories", required: ["name_en"], booleanFields: ["active"], integerFields: ["display_order"], fields: ["name_en","name_bn","active","display_order"] },
